...
assert(visualThemeSource.includes("scale: .25 !important") && visualThemeSource.includes("transform-origin: 50% 50% !important"), "start-page monster must shrink around its native layout center");
