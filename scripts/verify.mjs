...
assert(visualThemeSource.includes("scale: .14 !important") && visualThemeSource.includes("transform-origin: 50% 50% !important"), "start-page monster must shrink around its native layout center");
